...
from test3_slow_result import Ui_slow_result_3
from webcam_mediapipe import *
from webcam_mediapipe_right import *

class Ui_slow_input_3(object):
    def setupUi(self, MainWindow):
        ...
        webcam_apply_mediapipe_right().change_TaskID('Slow_03')
        webcam_apply_mediapipe().change_TaskID('Slow_03')
