...
class Ui_fast_result_3(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton.clicked.connect(lambda:sys.exit(QApplication(sys.argv).exec_()))
        #self.pushButton.clicked.connect(lambda:self.webcam_apply_mediapipe.terminate())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Click the SpaceBar to close\n"
                                                    ""))
        self.label_2.setText(_translate("MainWindow", "Fast Speed"))
        a = global_var.get_value('Final_Velocity')
        self.label_4.setText(_translate("MainWindow", "Your speed was:"+str(a)))
