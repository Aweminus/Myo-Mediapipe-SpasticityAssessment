...
class Ui_fast_result_3(object):
    def setupUi(self, MainWindow):
        ...
        self.timer.timeout.connect(lambda:sys.exit(QApplication(sys.argv).exec_()))
    ...
    def retranslateUi(self, MainWindow):
        ...
        fast_speed = global_var.get_value('fast_speed')
        if a<fast_speed-20:
            self.label_4.setText(_translate("MainWindow", "Your speed was too slow"))
        if (a >= fast_speed-20 and a <= fast_speed+20):
    ...
    def Refresh(self):
        ...
        self.countdown-=1
        self.label.setText(
            _translate("MainWindow", "Please wait " + str(self.countdown) + " seconds for ending the test..."))
