...
from test1_slow_ready import Ui_slow_ready_1
import global_var

class Ui_ready4assessment(QMainWindow):
    def setupUi(self, MainWindow):
        global_var.set_value('input_time', 10000)
        global_var.set_value('res_time', 6000)
        global_var.set_value('slow_speed', 80)
        global_var.set_value('mid_speed', 120)
        global_var.set_value('fast_speed', 340)
