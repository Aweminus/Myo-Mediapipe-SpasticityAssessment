...
class Ui_slow_guidance_1(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(125, 520, 750, 31))
        ...
        pathSuffix = r'\test_video.mp4'
        pathFile = pathPrefix +  pathSuffix
        
        self.playlist = QMediaPlaylist()
        self.playlist.addMedia(QMediaContent(QUrl.fromLocalFile(pathFile)))        
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow", "Move at 80°/s"))
        self.label_2.setText(_translate("MainWindow", "Slow Speed Guidance"))
