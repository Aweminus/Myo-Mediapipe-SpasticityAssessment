...
class webcam_apply_mediapipe_right(QThread):
    ...
    def stop1(self):
        ...
        # ========================= Compute avg velocity during stretch =========================        
        # ---------------------- Threshold Method ----------------------
        '''
        fastestVelocity = 0
        fastestIndex = 0
        ...
        print('highest peak - index: ', highestPeakIndex)            
        
        #plt.plot(peaks, velocityPeak, "x")
        #plt.plot(np.zeros_like(velocityrecFlt), "--", color="gray")
        #plt.show()       
        
        # For the averaging range, choose the 5 readings at the left and right of the peak
        startIndex = highestPeakIndex - 5
        endIndex = highestPeakIndex + 5

        print("------------------ Stretch Motion Mean -------------------")
