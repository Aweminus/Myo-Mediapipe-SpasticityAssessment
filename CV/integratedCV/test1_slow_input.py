...
# Form implementation generated from reading ui file 'test1_slow_input.ui'
#
...
from test1_slow_result import Ui_slow_result_1
from webcam_mediapipe import *
from webcam_mediapipe_right import *
import global_var

class Ui_slow_input_1(object):
...
##############Call the webcam and apply the mediapipe##########################################################
        ...
        webcam_apply_mediapipe_right().change_TaskID('Slow_01')
        webcam_apply_mediapipe().change_TaskID('Slow_01')
...
###############Open new window#########################################################
    ...
    def Refresh(self):
        _translate = QtCore.QCoreApplication.translate
        self.countdown-=1
        self.label.setText(_translate("MainWindow","Assessment Ongoing: " + str(self.countdown) + " seconds remaining..."))
